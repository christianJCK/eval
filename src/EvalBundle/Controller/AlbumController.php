...
class AlbumController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $albums = $em->getRepository('EvalBundle:Album')->findAll();
    ...
    {
        $album = new Album();
        $form = $this->createForm('EvalBundle\Form\AlbumType', $album);
    ...
    {
        $deleteForm = $this->createDeleteForm($album);
        $editForm = $this->createForm('EvalBundle\Form\AlbumType', $album);
